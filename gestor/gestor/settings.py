...
LOGOUT_REDIRECT_URL = 'autenticacao:login'  # Para redirecionar para a tela de login após o logout
LOGIN_URL = 'autenticacao:login'  # A URL 'login' da app 'autenticacao'
